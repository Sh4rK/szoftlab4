...
A projekt követelményeinek, felépítésének és funkcionalitásának ismertetése.

\subsection{Szakterület}
\comment{A kialakítandó szoftver milyen területen használható, milyen célra.}\newline
A szoftver nem egy kifejezett szakterület részére készül, általánosan felhasználható. Célja a szórakoztatás.
