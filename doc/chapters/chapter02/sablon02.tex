...
\hline
1.10 & Tornyot nem lehet útra építeni & bemutatás & fontos & megrendelő &  &  \tabularnewline
\hline
...
\hline
2.07 & Enterprise Architect &  & opcionális & csapat & UML modellező \tabularnewline
\hline
...
\subsection{Csapat}
A csapat 4 főből áll. A feladatokat úgy próbáljuk kiosztani, hogy lehetőleg mindenkinek azonos nehézségű feladatokat jusson, miközben a személyes preferenciáit is betartjuk.

\begin{longtable}{| l | p{7cm} | l | l | l | l |}
\hline
\textbf{Név} & \textbf{Feladatok} \tabularnewline
\hline\hline
\adam & Dokumentáció, UML, kód \tabularnewline
\hline
\antal & Dokumentáció, UML, kód \tabularnewline
\hline
\bator (csapatvezető) & Dokumentáció, UML, kód \tabularnewline
\hline
\torok & Dokumentáció, UML, kód \tabularnewline
\hline
