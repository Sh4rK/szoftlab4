...
\define{architecturális kép}{A szoftver belső felépítését szemléltető ábra.}
...
\define{akadály}{A játékos készítheti, az utakra lehet építeni. A rajta áthaladó ellenfeleket lelassítja. Lehet enchantolni.}
\define{cél}{A pályán kijelölt hely; ha ide eljutnak az ellenfelek, akkor vége a játéknak és a játékos vesztett.}
\define{életerő}{Egy szám, ami minden ellenfélhez rendelve van. Ha ez a szám eléri a 0-t vagy kisebb lesz, az ellenfél meghal.}
\define{ellenfél}{A pályán az utakon haladnak, van egy életerő tulajdonságuk, ami lövés hatására csökken, majd ha eléri a 0-t, akkor az ellenfél meghal.}
...
\define{játék elvesztése}{A játék egy lehetséges végződése, akkor következik be, ha egy ellenfél elér a célhoz.}
\define{játék megnyerése}{A játék egy lehetséges végződése, akkor következik be, az összes ellenfél meghal anélkül, hogy elérnének a célhoz.}
\define{lövés}{Az az esemény, amikor a torony egy a hatótávolságán belül lévő ellenfél életerejét csökkenti.}
\define{meghal}{Az az esemény, amikor egy ellenfél életereje eléri a 0-t.}
...
\define{út}{A pályán kijelölt rész, amin az ellenfelek eljuthatnak a célig. Az ellenfelek csak ezen haladhatnak, az akadályokat csak erre szabad építeni, a tornyokat viszont az utakra nem lehet építeni.}
\define{pálya}{Az a tér, amin a játék zajlik; ezen vannak az utak, és erre lehet építeni a tornyokat és akadályokat.}
\define{sebződés}{Ha egy ellenfél sebződést kap, akkor lemegy az életereje.}
\define{torony}{A játékos által készíthető dolgok közül a fontosabb; ezzel lehet megakadályozni az ellenfelek célhoz jutását. Lőni tud, és lehet enchantolni.}
...
\define{varázserő}{A játékos tulajdonsága; egy mennyiség, az ellenfelek elpusztulásakor növekszik, torony és akadály építésekor és enchantoláskor pedig csökken. A játékos csak akkor tud építeni és enchantolni, ha a jelenlegi varázserő több, mint amennyi az építéshez vagy enchantoláshoz szükséges.}
