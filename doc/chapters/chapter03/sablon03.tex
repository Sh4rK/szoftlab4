...
\item Metódusok
	\begin{itemize}
		...
		\item <<create>>(String file): Betölti a kapott elérési útvonalon a fájlt, és felépíti az alapján a pályát.
	\end{itemize}
\end{itemize}
...
\item Metódusok
	\begin{itemize}
		...
		\item <<create>>(String file): Betölti a kapott elérési útvonalon a fájlt, és felépíti az alapján a listát (spawnList).
	\end{itemize}
\end{itemize}
...
\item Metódusok
	\begin{itemize}
		...
		\item bool damage(int amount): Csökkenti az ellenség életerejét amount-al, igazzal tér vissza ha az ellenség meghalt.
