...
public class GraphicEnemy extends Drawable {
	...
	public GraphicEnemy(Enemy e){
		...
		if(e.getEnemyType() == EnemyType.human)
			img = ImageIO.read(new File(doc\images\ch11\icons\human.png));
		else if(e.getEnemyType() == EnemyType.dwarf)
			img = ImageIO.read(new File(doc\images\ch11\icons\dwarf.png));
		else if(e.getEnemyType() == EnemyType.elf)
			img = ImageIO.read(new File(doc\images\ch11\icons\elf.png));
		else if(e.getEnemyType() == EnemyType.hobbit)
			img = ImageIO.read(new File(doc\images\ch11\icons\hobbit.png));
	}
	@Override
